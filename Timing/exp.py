...
if __name__ == '__main__':
    ...
    with open('S_EncComputationTime.txt', 'a') as file:
    ...
    with open('S_DecrytionTime.txt', 'a') as file:
    ...
    with open('S_SampleTime.txt', 'a') as file:
